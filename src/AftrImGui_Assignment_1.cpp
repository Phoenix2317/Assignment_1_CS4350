...
void Aftr::AftrImGui_Assignment_1::draw()
{
   this->draw_orbit_controls();
}

void Aftr::AftrImGui_Assignment_1::draw_orbit_controls()
{
...
Aftr::Mat4 Aftr::AftrImGui_Assignment_1::compute_pose( Mat4 const& origin )
{
   if( !this->isPaused )
