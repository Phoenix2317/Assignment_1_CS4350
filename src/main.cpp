...
#include <vector>
#include <memory>
#include "GLViewAssignment_1.h" //GLView subclass instantiated to drive this simulation
...
int main( int argc, char* argv[] )
{
   ...
   do
   {
      std::unique_ptr< Aftr::GLViewAssignment_1 > glView( Aftr::GLViewAssignment_1::New( args ) );
